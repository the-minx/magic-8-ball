...
function askEightBall() {
  const questions = ['Does my crush like me?', 'Is my partner going to break up with me?', 'Do my parents love me?', 'Should I break up with my partner?','Am I going to survive Code Fellows?', 'Should I buy it?','Will I win a lottery ticket this year?','Will my jeans ever become loose on me?','Will the Magic 8 Ball end up in the trash if it does not give me the answer I want?'];
